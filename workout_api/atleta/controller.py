...
async def query(
    ...
    """
    Consulta todos os atletas com filtros opcionais:
    - /atletas → retorna todos
    - /atletas?nome=João → filtra por nome
    - /atletas?cpf=12345678900 → filtra por CPF
    - /atletas?nome=João&cpf=12345678900 → combina filtros
    """
